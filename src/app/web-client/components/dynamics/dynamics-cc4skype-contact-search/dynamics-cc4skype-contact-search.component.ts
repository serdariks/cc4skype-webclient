...
@Component({
  selector: 'app-dynamics-cc4skype-contact-search',
  templateUrl: './dynamics-cc4skype-contact-search.component.html',
  styleUrls: ['./dynamics-cc4skype-contact-search.component.css']
})
export class DynamicsCc4skypeContactSearchComponent extends ContactSearchBase {
