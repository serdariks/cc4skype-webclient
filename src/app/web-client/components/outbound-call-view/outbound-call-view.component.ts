...
@Component({
  selector: 'app-outbound-call-view',
  templateUrl: './outbound-call-view.component.html',
  styleUrls: ['./outbound-call-view.component.css']
})
export class OutboundCallViewComponent extends OutboundCallViewBase {
